...
export default function FindYourTeamHero() {
  return (
    <section className="relative">
      <div className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full pt-8">
          <Navigation />
          <div>
            <div className="text-white px-20 py-20 flex-2">
              <h2 className="text-[40px] md:text-5xl mb-6">Find Teams to Support</h2>
              <p className="text-[16px] mb-8">
                Discover sports teams in your community that need your support to achieve <br />
                their goals.
              </p>
            </div>
          </div>
