...
export default function FundraiserHero({ campaign = null }) {
    ...
    <section className="relative">
      <div className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full pt-8">
          <Navigation />
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px] items-center pt-16 px-4 sm:px-8 lg:px-16">
            <div className="text-center lg:text-left max-w-lg py-16 mx-auto lg:mx-0">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-2 font-manrope leading-tight">
                {campaignData.name}
              </h1>
            ...
            <div className="flex items-center justify-center lg:justify-end py-16">
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-white text-2xl sm:text-3xl font-bold mt-4">
                ...
                <Link href={`/donate/${campaignData.id || 1}`}>
                  <button className="bg-white text-black px-6 py-2 rounded-full hover:bg-[#0b1c3f] hover:text-white transition mt-2 sm:mt-4">
                    Donate Now
                  </button>
                </Link>
              </div>
